...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, filterProduct, queryOpts, payload, parsedQueryOpts, page, _b, unfilteredItems, hasNextPage, nextPage, items;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        sort = query.sort, limit = query.limit, filterProduct = query.filterProduct, queryOpts = __rest(query, ["sort", "limit", "filterProduct"]);
                    ...
                    case 2:
                        _b = _c.sent(), unfilteredItems = _b.docs, hasNextPage = _b.hasNextPage, nextPage = _b.nextPage;
                        items = unfilteredItems.filter(function (item) { return item.id !== filterProduct; });
                        return [2 /*return*/, {
                                items: items,
